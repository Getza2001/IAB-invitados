...
class DatosNoviosProvider extends ChangeNotifier {
  ...
  String idNov = '',
      ...
      fiestaLugar = '',
      fiestaHora = '';
  double misaLatitud = 0.0,
      misaLongitud = 0.0,
      recepcionLatitud = 0.0,
      recepcionLongitud = 0.0,
      fiestaLatitud = 0.0,
      fiestaLongitud = 0.0;
  ...
  getDatos(int idNovios) async {
    ...
    print(
        '**********************LLAMADA DESDE datos_novios_provider*************************');
    ...
    misaFecha = DateFormat('yyyy-MM-dd\nHH:mm:ss')
        .format(datosNoviosResponse.datos[0].misaFecha);
    ...
    recepcionFecha = DateFormat('yyyy-MM-dd\nHH:mm:ss')
        .format(datosNoviosResponse.datos[0].recepcionFecha);
    ...
    recepcionLatitud =
        double.parse(datosNoviosResponse.datos[0].recepcionLatitud);
    recepcionLongitud =
        double.parse(datosNoviosResponse.datos[0].recepcionLongitud);
    ...
    notifyListeners();
    print(
        '**********************CIERRE DE LLAMADA DESDE datos_novios_provider*************************');
  }
}
