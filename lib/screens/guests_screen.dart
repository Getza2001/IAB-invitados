...
import 'package:flutter_iab_invitados/providers/guests_provider.dart';
...
class _GuestsScreenState extends State<GuestsScreen> {
  ...
  //   return await prefs.getIdNovios();
  // }

  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: _crearAppBar(context), body: _crearListado());
  }

  Widget _crearListado() {
    return FutureBuilder(
      future: guestsProvider.getGuests(prefss.id_Novios),
      builder:
          (BuildContext context, AsyncSnapshot<List<GuestModel>> snapshot) {
        final guests = snapshot.data;

        if (snapshot.hasData) {
          print("en clase");
          print(prefss.id_Novios);
            ...
            return Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, i) =>
                    _crearItemGuest(context, guests[i], i),
              ),
            );
          } else {
            return Row(
              ...
              children: [
                Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 8.0),
                    Text('No se encontró ningún invitado',
          ...
          trailing: Row(
            ...
            children: [
              ...
              IconButton(
                  ...
                  onPressed: () async {
                    await Navigator.pushNamed(context, '/edit_guest',
                        arguments: guest);
                    setState(() {
